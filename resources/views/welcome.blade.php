...
<body style="height:100%">
    <nav class="navbar navbar-light sticky-top justify-content-between" id="navbar">
        ...
        <form class="form-inline"  data-aos="fade-left" data-aos-duration="3000">
            <a href="/user/login"><button type="button" class="btn btn-primary btn-custom1 mr-1">Login</button></a>
